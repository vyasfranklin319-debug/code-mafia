...
import { DetailedGameAnalyticsItem } from '../types/journey';
...
export const DeveloperJourneyDashboard: React.FC<DeveloperJourneyDashboardProps> = ({ onBack }) => {
  ...
  // Load dynamic journey data calculated from match history and telemetry engine
  const journey = useMemo(() => getPlayerDeveloperJourney('OperativeAlpha'), []);
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div className="gaming-card p-4 space-y-1">
                  ...
                  <span className="text-[10px] text-emerald-400 font-bold">Top 5% Operative</span>
                </div>
              </div>
